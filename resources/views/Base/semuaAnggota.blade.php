...
<div class="card m-3">
    <div class="card-header text-center">
        ...
        <div class="row m-3 d-flex justify-content-center">
            <a href="/semua-anggota-omk"
                class="col-md-2 link {{ request()->is('semua-anggota-omk') && !request()->has('stasi') ? 'active1' : '' }}">
                Semua
            </a>
            @foreach ($dataStasi as $item)
            @php
            $itemSlug = strtolower($item->slug);
            $currentSlug = strtolower(request()->query('stasi'));
            @endphp
            <a href="/semua-anggota-omk?stasi={{ $itemSlug }}"
                class="col-md-2 link {{ $itemSlug===$currentSlug ? 'active1' : '' }}">
                {{ $item->nama_stasi }}
            </a>
            @endforeach
        </div>
    ...
    <div class="card-body">
        ...
        @else
        <p>Anggota OMK aktif belum tersedia</p>
        @endif
    </div>
</div>
@endsection
